...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        const val savedDarkModeStateID = "SavedDarkModeState"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonLocationWidgetKotlinControl.setOnClickListener { startActivity(Intent(this, MapsActivity::class.java)) }
